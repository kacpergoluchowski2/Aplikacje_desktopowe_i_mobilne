...
* Napisz program, który poprosi u¿ytkownika o podanie liczby ca³kowitej i sprawdzi, czy jest ona dodatnia, ujemna lub równa zero. Wyœwietl odpowiedni komunikat.
* Napisz program, który poprosi u¿ytkownika o podanie dwóch liczb ca³kowitych i sprawdzi, czy s¹ one równe. Wyœwietl odpowiedni komunikat.
...
* Napisz program, który poprosi u¿ytkownika o podanie kwoty netto i obliczy wartoœæ podatku VAT oraz ca³kowit¹ kwotê brutto na podstawie podanego stawki VAT. Wyœwietl wyniki.
